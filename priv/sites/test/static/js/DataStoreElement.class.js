DataStoreElement=function()
{
  ...
  this.model = new DataStore(this);
  this.setTitle( this.getModel().name ); 
}

DataStoreElement.prototype = new draw2d.CompartmentFigure;

DataStoreElement.prototype.getModel = function(){
	return this.model;
}
 ...
 * @private
 **/
DataStoreElement.prototype.createHTMLElement=function()
{
...
DataStoreElement.prototype.setTitle= function(title /*:String*/){
	//this.title = title;
	$(this.titlebar).text(title+ ' - DataStore');
}

DataStoreElement.prototype.fixBugCompartmentFigureResize = function(/*:draw2d.Figure*/ figure){
...
DataStoreElement.prototype.onFigureEnter = function(/*:draw2d.Figure*/ figure){
...
DataStoreElement.prototype.onFigureLeave = function(/*:draw2d.Figure*/ figure){
...
DataStoreElement.prototype.onFigureDrop = function(/*:draw2d.Figure*/ figure){
...
DataStoreElement.prototype.setDimension=function( w /*:int*/, h /*:int*/){
...
DataStoreElement.prototype.getMinWidth=function(){
  return 150;
}


DataStoreElement.prototype.getMinHeight=function(){
  return 100;
}


DataStoreElement.prototype.setBackgroundColor= function(/*:draw2d.Color*/ color){
  this.bgColor = color;
