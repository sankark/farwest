ResourceElement=function()
{
  ...
  this.model = new Resource(this);
  this.setTitle( this.getModel().name ); 
}

ResourceElement.prototype = new draw2d.CompartmentFigure;

ResourceElement.prototype.getModel = function(){
	return this.model;
}
 ...
 * @private
 **/
ResourceElement.prototype.createHTMLElement=function()
{
...
ResourceElement.prototype.setTitle= function(title /*:String*/){
	//this.title = title;
	$(this.titlebar).text(title+ ' - Resource');
}

ResourceElement.prototype.fixBugCompartmentFigureResize = function(/*:draw2d.Figure*/ figure){
...
ResourceElement.prototype.onFigureEnter = function(/*:draw2d.Figure*/ figure){
...
ResourceElement.prototype.onFigureLeave = function(/*:draw2d.Figure*/ figure){
...
ResourceElement.prototype.onFigureDrop = function(/*:draw2d.Figure*/ figure){
...
ResourceElement.prototype.setDimension=function( w /*:int*/, h /*:int*/){
...
ResourceElement.prototype.getMinWidth=function(){
  return 150;
}


ResourceElement.prototype.getMinHeight=function(){
  return 100;
}


ResourceElement.prototype.setBackgroundColor= function(/*:draw2d.Color*/ color){
  this.bgColor = color;
