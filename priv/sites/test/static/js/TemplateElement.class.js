...
TemplateElement.prototype = new draw2d.CompartmentFigure;

TemplateElement.prototype.getModel = function(){
	return this.model;
}
 ...
 * @private
 **/
TemplateElement.prototype.createHTMLElement=function()
{
...
TemplateElement.prototype.setTitle= function(title /*:String*/){
	//this.title = title;
	$(this.titlebar).text(title+ ' - Template');
}

TemplateElement.prototype.fixBugCompartmentFigureResize = function(/*:draw2d.Figure*/ figure){
...
TemplateElement.prototype.onFigureEnter = function(/*:draw2d.Figure*/ figure){
...
TemplateElement.prototype.onFigureLeave = function(/*:draw2d.Figure*/ figure){
...
TemplateElement.prototype.onFigureDrop = function(/*:draw2d.Figure*/ figure){
...
TemplateElement.prototype.setDimension=function( w /*:int*/, h /*:int*/){
...
TemplateElement.prototype.getMinWidth=function(){
  return 150;
}


TemplateElement.prototype.getMinHeight=function(){
  return 100;
}


TemplateElement.prototype.setBackgroundColor= function(/*:draw2d.Color*/ color){
  this.bgColor = color;
