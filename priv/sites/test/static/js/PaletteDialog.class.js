...
PaletteDialog = function (/*draw2d.workflow*/ workflow) {
    var oThis = this;
	this.defaultSize = new Array(123,250);
	...
	var createElement = function(tool_element, drag_stop_event) {
		...
		}else if ( tool_id == 'tool_resource' ){
            element_to_add = new ResourceElement();
        }else if ( tool_id == 'tool_template' ){
            element_to_add = new TemplateElement();
        }else if ( tool_id == 'tool_datastore' ){
            element_to_add = new DataStoreElement();
        }else{
	...
	var initialize = function(){
        ...
        html += getHTMLTool('tool_template','Template');
        html += getHTMLTool('tool_datastore','DataStore');
        html += getHTMLTool('tool_resource','Resource');
