...
function main(){
	...
	if (!(window.application)){
		...
		var scripts = new Array(
            ...
            '<script type="text/javascript" src="js/ResourceElement.class.js"></script>',
            '<script type="text/javascript" src="js/TemplateElement.class.js"></script>',
            '<script type="text/javascript" src="js/DataStoreElement.class.js"></script>',
