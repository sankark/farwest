...
CommandListener.prototype.stackChanged=function(/*:draw2d.CommandStackEvent*/ event){
	...
	var changePageOfState = function( command, event_type ){
		...
		var old_page = (command.oldCompartment!=null && command.oldCompartment.getModel && (command.oldCompartment.getModel() instanceof Page || command.oldCompartment.getModel() instanceof Resource) ) ? command.oldCompartment.getModel() : null;
		var new_page = (command.newCompartment!=null && command.newCompartment.getModel && (command.newCompartment.getModel() instanceof Page || command.newCompartment.getModel() instanceof Resource) ) ? command.newCompartment.getModel() : null;
    ...
    var changeResourceOfState = function( command, event_type ){
        var state = ( command.figure.getModel && (command.figure.getModel() instanceof State) ) ? command.figure.getModel() : null;
        var old_page = (command.oldCompartment!=null && command.oldCompartment.getModel && (command.oldCompartment.getModel() instanceof Resource) ) ? command.oldCompartment.getModel() : null;
        var new_page = (command.newCompartment!=null && command.newCompartment.getModel && (command.newCompartment.getModel() instanceof Resource) ) ? command.newCompartment.getModel() : null;
