{application,farwest,
             [{description,"REST-based web development environment."},
              ...
              {modules,[farwest,farwest_app,farwest_base_dtl,farwest_sup,
                        file_handler,file_handler2,file_util,fw_auth,
                        fw_config,fw_css_handler,fw_data_server,
                        ...
                        login_handler,orion_client_handler,preview_handler,
                        resource_base,template_handler,users_handler,util,
                        workspace_handler]},
