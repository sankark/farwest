{application,farwest,
             [{description,"REST-based web development environment."},
              ...
              {modules,[compile_handler,farwest,farwest_app,farwest_base_dtl,
                        farwest_sup,file_handler,file_handler2,file_util,
                        ...
                        login_handler,mod_compile,orion_client_handler,
                        preview_handler,resource_base,template_handler,
                        users_handler,util,workspace_handler]},
